...
class ProductModel: Mappable {
    ...
    func mapping(map: ObjectMapper.Map) {
        ...
        prodType           <- map["prodType"]
        saleTags           <- map["saleTags"]
        price           <- map["price"]
        rawPrice           <- map["rawPrice"]
        prodPlace           <- map["prodPlace"]
        thumbUrl           <- map["thumbUrl"]
        shouFlag           <- map["shouFlag"]
        feature           <- map["feature"]
        recommendFlag           <- map["recommendFlag"]
        saleNum           <- map["saleNum"]
        saleStatus           <- map["saleStatus"]
        prodSource           <- map["prodSource"]
        unit           <- map["unit"]
        detailInfo           <- map["detailInfo"]
        params           <- map["params"]
        deliverDay           <- map["deliverDay"]
        select           <- map["select"]
        buyNum           <- map["buyNum"]
        items           <- map["items"]
        saleLimit           <- map["saleLimit"]
        salesType           <- map["salesType"]
        availableNum           <- map["availableNum"]
        newFlag           <- map["newFlag"]
        brandName           <- map["brandName"]
        hasFav           <- map["hasFav"]
        topicItems           <- map["topicItems"]
        bindSpu           <- map["bindSpu"]
        discountPoint           <- map["discountPoint"]
        specialPrice           <- map["specialPrice"]
        companyNo           <- map["companyNo"]
        discountPointAmount           <- map["discountPointAmount"]
//        topicItems           <- map["topicItems"]
//        topicItems           <- map["topicItems"]
